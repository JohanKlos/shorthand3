...
Read_variables:
	f_dbgtime(gen,dbg,A_LineNumber,"Read_variables","start",1)
	...
	icon_shorthand	= %img_folder%\icon_shorthand.ico
	...
	f_dbgtime(gen,dbg,A_LineNumber,"Read_variables","stop",1)
Return
...
;		GUI +resize -MaximizeBox  ; +resize will activate the maximizebox, -MaximizeBox is to prevent that
	...
	GUI Add, Text, ys+1 h20 w75 vset_advanced border gset_advanced border center, advanc&ed
...
set_filter_extensions_text:	; this can be optimised, like GUI2_set is
	...
	if filter_extensions = 1
		GUIControl,, filter_extensions, 0
	else
		GUIControl,, filter_extensions, 1	
...
set_filter_folders_text:
	GUI, submit, nohide
	if filter_folders = 1
		GUIControl,, filter_folders, 0
	else
		GUIControl,, filter_folders, 1	
set_filter_folders:
	GUI, submit, nohide
...
set_filter_ignores_text:
	GUI, submit, nohide
	if filter_ignores = 1
		GUIControl,, filter_ignores, 0
	else
		GUIControl,, filter_ignores, 1	
set_filter_ignores:
	GUI, submit, nohide
...
set_restricted_mode_text:
	...
	if restricted_mode = 1
		GUIControl,, restricted_mode, 0
	else
		GUIControl,, restricted_mode, 1	
set_restricted_mode:
	GUI, submit, nohide
...
command_run:
	...
	{
		StringTrimLeft, command_search, command_search, 5
		StringReplace, command_search, command_search, %A_Space%, `%20, ALL
		run, http://www.google.com/cse?cx=008894931886257774458:qsymwz_o1tq&hl=en&q=%command_search%
		GoSub sub_clear
		f_dbgtime(gen,dbg,A_LineNumber,"timer_execute_search","stop",2)
		return
	}
